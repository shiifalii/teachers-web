...
function PublishSuccessPopup(props: Props) {
  ...
  return (
    <Dialog onClose={onClose} aria-labelledby="publish-result" open={open}>
      <DialogTitle id="customized-dialog-title" onClose={onClose}>
        <DialogTitleEdit> Published Successfully</DialogTitleEdit>
      </DialogTitle>
      <DialogContent>
        <p>
          <img src="https://mypat-v2-prod.s3-us-west-2.amazonaws.com/webcontent/web_img/teacher-v3/check-rounded-icon.svg" />
        </p>
        <DialogBodyText>
          Students will be notified once their result has been published
        </DialogBodyText>
      </DialogContent>
      <DialogActions>
        <CTAButton
